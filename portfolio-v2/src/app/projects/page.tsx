...
import { SimpleMousetrail } from "@/components/ui/ImageMousetrail";
import { TiltCardSimple } from "@/components/ui/TiltCard";
...
export default function Projects() {
  return (
    <SimpleMousetrail color="#00D9FF" dotSize={10} trailLength={8}>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-32">
          ...
          <div className="mt-16 p-8 bg-white dark:bg-[#111111] border border-border dark:border-gray-800">
            ...
            <p className="text-textMuted dark:text-gray-400 text-sm">
              I'm actively working on several internal tools and open source
              contributions. Check back soon for updates, or reach out to
