      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 py-32">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-gray-400 leading-relaxed">
            Recently, I've been deep in agentic AI infrastructure — designing multi-agent orchestration systems, building MCP servers, and engineering context pipelines that make AI coding assistants dramatically more effective. It's the intersection of systems thinking and AI that I find most compelling: building the scaffolding that lets agents operate reliably at scale.
          </p>
        </div>
